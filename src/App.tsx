  ...
  return (
    <>
      ...
      <p style={{ width: "350px", textAlign: "center" }}>
        ...
        modelagem vai agradar o corpo padrão masculino. Modelo M e G padrão.
        Tentamos deixar o design da gola mais agradável usando um modelo de gola
        esporte. Esse design valoriza o caimento e deixa mais formal mesmo
